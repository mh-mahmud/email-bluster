<?php 
  include_once base_path().DIRECTORY_SEPARATOR."email_template_builder".DIRECTORY_SEPARATOR."config.php";
  ...
  function createHtmlandZipFile($html='')
  {
    ...
    //read email template
    $templateContent=file_get_contents(EMAIL_TEMPLATE_DIRECTORY."template.html",true);
