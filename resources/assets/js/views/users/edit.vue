                    ...
                    <form class="m-form" @submit.prevent="updateUser">
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row" :class="errors.has('designation') || validationErrors.designation ? 'has-error' : ''">
                                    <label class="col-lg-3 col-form-label"  for="designation">Designation:<span class="required">*</span></label>
                                    <div class="col-lg-6">
                                        <input data-vv-as="Designation" name="designation" v-validate="'required|max:20'"  v-model="user.designation" type="text" class="form-control m-input" placeholder="Enter Designation">
                                        <span class="m-form__help" v-if="errors.has('designation') || validationErrors.designation">
                                            {{ errors.first('designation') || validationErrors.designation[0] }}
                                        </span>
                                    </div>    
                                </div>
